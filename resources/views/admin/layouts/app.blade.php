...
<body class="crm_body_bg">
    ...
    <nav class="sidebar bg-white">
        ...
        <ul id="sidebar_menu">
            ...
            <li class="mm">
                <a href="/admin/mce_profile" aria-expanded="false">
                    <img src="/image/menu-icon/2.svg" alt="">
                    <span>MCE Profile Request</span>
                </a>
            </li>
            <li class="mm">
                <a href="/admin/mce_form" aria-expanded="false">
                    <img src="/image/menu-icon/2.svg" alt="">
                    <span>MCE Form</span>
                </a>
            </li>
            <li class="mm">
                <a href="/admin/jobs" aria-expanded="false">
                    <img src="/image/menu-icon/2.svg" alt="">
                    <span>Jobs</span>
                </a>
            </li>
            <li class="mm">
                <a href="/admin/invitation" aria-expanded="false">
                    <img src="/image/menu-icon/2.svg" alt="">
                    <span>Invitation</span>
                </a>
            </li>
            <li class="mm">
                <a href="/admin/events" aria-expanded="false">
                    <img src="/image/menu-icon/2.svg" alt="">
                    <span>Events / Seminor</span>
                </a>
            </li>    
            <li class="mm">
